...
export function createOpenVikingClientRuntime(options) {
    ...
    const routingDebugLog = cfg.logFindRequests
        ...
        : undefined;
    const clientPromise = Promise.resolve(new OpenVikingClient(cfg.baseUrl, cfg.apiKey, cfg.peer_prefix, cfg.timeoutMs, cfg.accountId, cfg.userId, routingDebugLog, { transport: options.transport }));
